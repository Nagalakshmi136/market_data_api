...
from app.utils.smartapi.constants import (
    ...
    NSE_HOLIDAYS_PATH,
    NSE_SYMBOLS_PATH,
    POSSIBLE_INTERVALS_AND_MAXDAYS,
)
...
def validate_interval(interval: str) -> str:
    ...
    Refer this page for valid intervals: https://smartapi.angelbroking.com/docs/Historical.
    ...
    """
    possible_intervals = POSSIBLE_INTERVALS_AND_MAXDAYS.keys()
...
def validate_datetime(date_time: str) -> datetime:
    ...
    Refer this page to know valid format of date and time: https://smartapi.angelbroking.com/docs/Historical.
...
def validate_date_range(
    ...
    Refer this page for valid date range for given interval: https://smartapi.angelbroking.com/docs/Historical.
    ...
    if total_days >= 0 and total_days <= POSSIBLE_INTERVALS_AND_MAXDAYS[interval]:
        return start_date.strftime("%Y-%m-%d %H:%M"), end_date.strftime(
            "%Y-%m-%d %H:%M"
        )
    raise InvalidDateRangeBoundsException(
        from_date, to_date, POSSIBLE_INTERVALS_AND_MAXDAYS[interval], interval
    )
